const faq = [
    {
        question: 'Fraktal is governed by the Community run Fraktal DAO which manges the protocol and value of the ecosystem. Anyone can receive voting power by staking FRAK, the Fraktal Governance Token.',
