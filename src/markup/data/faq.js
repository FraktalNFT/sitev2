const faq = [
    {
        question: 'Fraktal is governed by the Community run Fraktal DAO which manages the protocol and value of the ecosystem. Anyone can receive voting power by staking FRAK, the Fraktal Governance Token.',
